  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-slate p-4 md:p-0">
      <div className="w-full max-w-md">
        ...
        {/* Register Card */}
        <div className="card">
          <h2 className="text-xl md:text-2xl font-bold mb-4 md:mb-6">Create Account</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-3 md:space-y-4">
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-xs md:text-sm font-medium mb-2">
                Confirm Password
              </label>
              <input
                id="confirmPassword"
